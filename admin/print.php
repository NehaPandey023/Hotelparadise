...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>【﻿Ｐａｒａｄｉｓｅ　Ｉｎｎ】,</p>
				<p>Near Khelgaon Stadium,<br>HB Road,<br>Ranchi -835217 Jharkhand</p>
				<p>(+91) 7903931497</p>
			</address>
			<span><img alt="" src="assets/img/abc.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@paradiseinn.com || Web :- www.paradiseinn.com || Phone :- +91-7903931497 </p>
			</div>
		</aside>
	</body>
</html>
